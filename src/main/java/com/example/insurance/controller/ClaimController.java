...
public class ClaimController {
    ...
    public ResponseEntity<ApiResponse<ClaimResponse>> addClaim(@RequestBody AddClaimRequest request){
        return new ResponseEntity<>(claimService.addClaim(request), HttpStatus.OK);
    }

    @PutMapping("/update-claim")
    public ResponseEntity<ApiResponse<ClaimResponse>> updateClaim(@RequestParam("claimId") Integer claimId,
    ...
    public ResponseEntity<ApiResponse<List<ClaimResponse>>> getAllClaims(@RequestParam("customerId") Integer customerId){
